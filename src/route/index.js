  ...
  res.render("task21", {
    ...
    nested_display: {
      ...
      children_display: {
        ...
        text:
          "tags that have been identified as deprecated and not recommended for use in HTML version 5",
        button: {
          text: "Орen",
        },
      },
    ...
    section: {
      ...
      agreement: {
        ...
        info: {
          ...
          detail: {
            text:
              "By using or accessing the service, you agree to be bound by the terms and conditions outlined in the agreement.",
            button: "Аccept",
          },
        },
      },
          ...
          coments: [
            {
              ...
              date: "1 січня 2023",
              text:
                "Дякую за відгук, я подумаю про недоліки, про які ви згадували, перш ніж зробити покупку.",
            },
            {
              userName: "Користувач",
              date: "3 січня 2023",
              text:
                "Дякую за корисний відгук! Це допомогло мені зробити вибір щодо покупки ноутбука.",
            },
            {
              userName: "Користувач",
              date: "10 січня 2023",
              text:
                "Дякую за відгук, але я хотів би дізнатися більше деталей про проблеми з перегрівом, щоб зробити зважений вибір перед покупкою.",
            },
          ],
        },
      },
